...
<body>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			...
			<li class="icn_categories"><a href="http://localhost:8095/Budo91/index.php/admin_clubs"  style="font-weight: bold;">Lister les clubs</a></li>
	...
	<section id="main" class="column">
		...
		<div class="tab_container">
			...
			<tbody> 
	 <?php foreach ($clubs_liste as $club): ?>
                    <?php echo '<tr>'; ?> 
   				    <?php echo '<td><input type="checkbox"></td>';?> 
    				<?php echo '<td>'.htmlentities($club->nom).'</td>';?> 
    				<?php echo '<td>'.htmlentities($club->desc).'</td>';?> 
